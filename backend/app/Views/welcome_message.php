...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/community" >Community</a></li>
    ...
    <div class="heroe">
        ...
        <h1>YOUR ARE HERE <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<div class="further">
    ...
    <section>
        ...
        <p>The User Guide contains an introduction, tutorial, a number of "how to"
            ...
            the framework. Check the <a href="/documentation"
            >User Guide</a> !</p>
        ...
        <p>CodeIgniter is a community-developed open source project, with several
             ...
             the threads on <a href="/about#community"
        ...
        <p>CodeIgniter is a community driven project and accepts contributions
             ...
             <a href="https://codeigniter.com/contribute" >
             join us</a> ?</p>
